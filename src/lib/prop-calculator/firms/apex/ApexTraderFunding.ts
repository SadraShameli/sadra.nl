...
export class ApexTraderFunding extends TradingFirm {
    ...
    readonly notes = [
        ...
        "The confirmed 5-Pack Evaluation Bundle (Apex's own help article confirms it exists and covers 50K, for both Intraday and EOD) has its exact discount percentage explicitly flagged as unconfirmed -- the article points to a client-side-rendered product picker this sweep couldn't read -- not guessed at, consistent with the decision not to build a bulk-purchase mechanism for Apex without a confirmed number.",
    ];
