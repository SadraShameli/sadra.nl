...
function emptyComponentScores(): Record<WeightCategory, ComponentScore> {
    const blank = { earned: 0, max: 0, label: '', note: '' };
    return {
        mental: blank,
        context: blank,
        bias: blank,
...
function scoreContext(
    ...
    return {
        score: { earned, max, label: 'Session context', note: '' },
        strengths,
        weaknesses,
    };
}
...
function scoreDol(
    ...
    return {
        score: { earned, max, label: 'Draw on liquidity', note: '' },
        strengths,
        weaknesses,
    };
}
...
function scoreState(
    ...
    return {
        score: { earned, max, label: 'Market state', note: '' },
        strengths,
        weaknesses,
    };
}
