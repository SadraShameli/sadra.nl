...
export default async function HomePage() {
    return (
        <>
            ...
            <main className="grid w-full px-6 lg:px-0">
                <RevealAnimation>
                    <div className="container flex h-screen items-center justify-center gap-5 lg:gap-24">
                        <div className="flex flex-col">
                            <h1 className="text-4xl font-bold text-white lg:text-7xl">{resumeSadra.basics.title}</h1>
                        ...
                        <Image
                            className="size-48 rounded-2xl object-cover lg:size-96"
                            src={ProfilePicture}
                            alt="Profile picture"
                            loading="eager"
                            priority
