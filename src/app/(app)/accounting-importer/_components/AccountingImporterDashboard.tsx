...
import type {
    ImportEvent,
    Stage,
} from '~/lib/accounting-importer/runner-types';
...
import { STAGES } from '~/lib/accounting-importer/runner-types';
...
export function AccountingImporterDashboard() {
    ...
    const handleRun = async () => {
        ...
        await stream.start({
            ...
            method: 'POST',
            url: apiRoutes.accountingImporter.run,
        });
    };
