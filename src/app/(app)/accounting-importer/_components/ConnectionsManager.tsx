...
import type { CredentialKind } from '~/lib/accounting-importer/credentials/registry';
...
export function ConnectionsManager() {
    ...
    const credentialsQ = api.accountingImporter.credentials.list.useQuery();
    const testMut = api.accountingImporter.credentials.test.useMutation();
    const deleteMut = api.accountingImporter.credentials.delete.useMutation({
        onSuccess: async () => {
            await utils.accountingImporter.credentials.list.invalidate();
            await utils.accountingImporter.summary.invalidate();
        },
    });
...
function EditCredentialForm({
    ...
    const updateMut = api.accountingImporter.credentials.update.useMutation();
...
function NewCredentialDialog({
    ...
    const createMut = api.accountingImporter.credentials.create.useMutation();
    const form = useForm<
