...
import type { CredentialMetaField } from '~/lib/accounting-importer/credentials/index';
...
export function SelectFieldInput({
    ...
    const loadMut = api.accountingImporter.fieldOptions.load.useMutation();
    const loadForCredentialMut =
        api.accountingImporter.fieldOptions.loadForCredential.useMutation();
