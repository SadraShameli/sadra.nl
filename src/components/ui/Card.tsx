...
function CardHeader({ className, ...properties }: React.ComponentProps<'div'>) {
    return (
        <div
            className={cn(
                '@container/card-header flex auto-rows-min grid-rows-[auto_auto] flex-wrap items-center justify-between gap-3 px-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6',
                className,
            )}
