...
const Resume: IResume = {
    ...
    basics: {
        ...
        phone: '+31685156033',
        summary: `I am Sadra Shameli, ${age} years old, living in Rijswijk, The Netherlands. I trade index futures and crypto. Besides that, I build cool things and love photography.`,
        location: {
