...
**Inactivity rule, now directly confirmed, resolving a previously-flagged engine/doc disagreement.** This tree's own simulator engine had already modeled a 7-day idle-closure rule for Growth, citing a "Guidelines for Traders" article that, at the time, hadn't been located or read as a source for this file. That article has now been read directly (found via a full sitemap sweep of `help.tradeify.co`): "To keep your funded or evaluation account active, you must place at least one trade per week (Monday through Friday). This is per account, not per user. Failure to do so may result in your account being marked as inactive." Applies to both Evaluation and Sim Funded stages, stated without a per-plan qualifier, so treated as firm-wide (independently corroborated for every plan in `README.md`'s Firm-Wide Rules). "One trade per week" is treated as equivalent to the engine's own 7-day figure. "Essential Trading Rules Overview" independently corroborates the same weekly requirement and adds a detail neither "Guidelines for Traders" nor the Funded Trader Agreement states: the qualifying trade "can be as brief as 5 seconds as long as it satisfies the minimum activity requirement," so any trade counts, not just a substantively held one.
...
| News Trading             | Allowed, no restrictions — "We do not have any rules against or guidelines around trading news events... trade AT YOUR OWN RISK" ("Rules: News Trading"). No stage qualifier stated; treated as applying to Evaluation too. |
