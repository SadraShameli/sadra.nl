...
- https://help.tradeify.co/en/articles/14068315-tradeify-elite-accelerator-reward-pools ("Updated over 3 weeks ago"; found via a full sitemap sweep of `help.tradeify.co`, primary source for the Accelerator Reward Pools section)
...
**1.5x Performance Multiplier**: exclusively available to Select-plan-origin accounts. Both conditions must be met at the moment of live transition: Sim Funded consistency score below 40%, and the account never exceeded 75% of its allowed max drawdown during Sim Funded. The multiplier is applied per account at transition, a one-time determination, not something earned later or re-evaluated monthly.
