...
**A discretionary clawback/withholding right over bonus funds may apply, but this is flagged as uncertain rather than merged in as settled fact.** A separate disclaimer document, "Topstep Octagon Performance Bonus Disclaimer" (last updated 2026-07-31, after the old Live Performance Bonus was retired July 1, 2026), states: "Topstep reserves the right to adjust, withhold, revoke, or terminate LPB funds if it determines in its sole discretion there has been a violation of trading rules, ineligibility, or noncompliance with regulatory requirements." Two things make this uncertain rather than a clean citation: the document still internally calls the bonus "LPB" (the retired program's own abbreviation) and describes it as "promotional trading credit... for use as additional trading balance," which reads differently from this section's own description of Octagon payouts as cash "added to your account balance the following month." It is not established whether this disclaimer's terms govern the current Octagon program under old internal naming, or are stale language left over from the retired bonus and never updated post-rebrand. Either way, no clawback/withholding right over Octagon winnings is stated anywhere else in this section; do not assume Octagon payouts are free of this risk, and do not assume this disclaimer definitely still applies, without checking directly with Topstep.
...
- **Trading platform is TopstepX™, resolving a dated conflict:** the "New to Topstep? Start here" article (8284199, updated 2026-07-20) states "TopstepX™ is the only available trading platform." This postdates, and is treated as superseding, the older "What are the costs in the Live Funded Account?" article's (8284229, updated 2026-06-16) "many supported platforms" language above, which describes Combine-stage platform-cost coverage rather than making its own claim about which platforms currently exist; the newer statement reads as a platform consolidation the older cost article predates, resolved here by recency between two same-tier help-center sources. Do not assume multiple platforms remain available for the LFA.
...
- **"May be" vs. "will be" liquidated at the $1,000 floor, a confirmed conflict not resolvable by authority ranking** — see "The $1,000 Auto-Liquidation Floor" above (the separate $1,000-vs-$0 floor question there is treated as resolved in favor of $1,000, per the LFA Parameters article's dedication and later update date, 2026-09-17 vs. 2026-09-10; the $0 wording is flagged, not discarded). But the "may be"/"will be" wording comes from the same LFA Parameters article, in its CALLOUT box and its FAQ respectively, on the same date, so dedication and recency cannot break that tie. Do not assume either the discretionary ("may") or the automatic ("will") reading is correct. A third data point, from the Topstep Payout Policy article: "Note: Requesting a full 100% Payout closes your LFA since the balance reaches the Maximum Loss Limit." That sentence implies the LFA's Maximum Loss Limit sits at the account's own starting balance rather than $1,000 below it, but it is a note about a payout consequence, not a statement of the floor, and it does not resolve this conflict either.
...
- help.topstep.com, Article ID 8284199, "New to Topstep? Start here." (updated 2026-07-20). Source of the "TopstepX™ is the only available trading platform" statement used to resolve the platform conflict in Other Confirmed Rules; not previously listed here despite being cited by this file's Not Confirmed section. Added 2026-09-22.
