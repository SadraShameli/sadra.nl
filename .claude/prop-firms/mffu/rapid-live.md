...
Rapid Live accounts begin at $0 balance and operate under an end-of-day calculated maximum loss limit. The maximum loss limit trails upward based on the account's end-of-day balance. Once the maximum loss limit reaches $0, it stops trailing and becomes locked at that floor. Reaching the maximum loss limit triggers immediate account closure. The account may accumulate negative balance during intraday trading before the end-of-day calculation, which is normal and expected.
